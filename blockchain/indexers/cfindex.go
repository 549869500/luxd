...
func storeFilter(dbTx database.Tx, block *luxutil.Block, f *gcs.Filter,
	extended bool) error {
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *luxutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *luxutil.Block,
	view *blockchain.UtxoViewpoint) error {
