...
import (
	...
	peerpkg "github.com/bitbandi/luxd/peer"
...
type PeerNotifier interface {
	...
	TransactionConfirmed(tx *luxutil.Tx)
}
...
func (b *blockManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*luxutil.Block)
		if !ok {
...
// processed.
func (b *blockManager) QueueTx(tx *luxutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (b *blockManager) QueueBlock(block *luxutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
func (b *blockManager) ProcessBlock(block *luxutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
