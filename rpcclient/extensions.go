...
//
// NOTE: This is a luxd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []luxutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []luxutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
