...
func GetBlockWeight(blk *luxutil.Block) int64 {
...
func GetTransactionWeight(tx *luxutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *luxutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
