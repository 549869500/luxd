...
func (view *UtxoViewpoint) AddTxOuts(tx *luxutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *luxutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *luxutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *luxutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *luxutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *luxutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
