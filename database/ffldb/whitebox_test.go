...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*luxutil.Block, error) {
	...
	blocks := make([]*luxutil.Block, 0, 256)
	genesis := luxutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
