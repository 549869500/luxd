...
/*
luxd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means luxd will work 'out of
...
parsed when luxd starts up.  By default, the configuration file is located at
~/.luxd/luxd.conf on POSIX-style operating systems and %LOCALAPPDATA%\luxd\luxd.conf
