...
// luxutil.Block.  This is largely borrowed from the test code in luxdb.
func loadBlocks(filename string) (blocks []*luxutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = luxutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
