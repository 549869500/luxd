...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *luxutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := luxutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(luxutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a luxutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*luxutil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*luxutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*luxutil.Block, error) {
